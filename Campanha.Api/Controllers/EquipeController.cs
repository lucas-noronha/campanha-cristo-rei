...
namespace Campanha.Api.Controllers
{
    ...
    {
        public EquipeServico Servico { get; set; }
        public EquipeController(EquipeServico servico)
        {
            Servico = servico;
        }
        [HttpGet("obter/{id}")]
        ...
        [HttpPost("adicionar")]
        public IActionResult Adicionar([FromBody] EquipeDto dto)
        {
        ...
        [HttpPut("editar")]
        public IActionResult Editar([FromBody] EquipeDto dto)
        {
